...
urlpatterns = [
    ...
    path("create-integration-assignments/", integrations.create_integration_assignments, name="create_integration_assignments"),
    path("update-integration-courses/", integrations.update_integration_courses, name="update_integration_courses"),
...
CONDITIONALLY_EXCLUDE_FROM_STATE_EVALUATION = (
    # having create_integration_assignments in this list used to run the risk of having the
    # "your assignments are outdated" alert to run (see bb9dac2) 
    # Though this is not rigorously tested, evaluating state for create_integration_assignments
    ...
    # delayed
    "create_integration_assignments", )
EXCLUDE_FROM_UPDATING_STATE = ("evaluate_changed_state", "update_integration_courses", "gc_auth_callback", "canvas_auth_callback", )
