...
# home and account_login must be the last ones so base.js can reload
# settings must be here for three reasons:
...
RELOAD_VIEWS = ('example_settings', 'settings', 'home', 'account_login', )
