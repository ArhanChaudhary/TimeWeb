...
class SettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            ...
            "ignore_ends": "Ignores the minimum work time for the first and last working days of EVERY assignment with a minimum work time in exchange for making their work distributions smoother on their first and last working days. Recommended to be enabled.",
