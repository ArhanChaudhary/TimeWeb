...
class SettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            ...
            "timezone": "Backend calculations use your browser's timezone for various calculations. If your browser doesn't imply your timezone, choose your timezone here.",
